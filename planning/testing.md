...
- `googlePlaceId` is submitted with leading or trailing whitespace - trimmed before the duplicate check runs, so the same restaurant cannot be created twice because of stray spaces.
